...
var absgammalnf = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
	'skip': ( absgammalnf instanceof Error )
};
...
tape( 'the function evaluates the natural logarithm of the absolute value of the gamma function (positive integers)', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var i;
...
tape( 'the function evaluates the natural logarithm of the absolute value of the gamma function (decimal values)', opts, function test( t ) {
	var expected;
	var x;
	var y;
	var i;
...
tape( 'the function evaluates the natural logarithm of the absolute value of the gamma function for x >= 2^27', opts, function test( t ) {
	var expected;
	var x;
	var v;
